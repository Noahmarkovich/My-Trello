  ...
  return (
    <section className="login-page">
      ...
      <div className="img-container">
        <img
          src="https://merllo.onrender.com/static/media/left-loginsignup-hero.47238298680cf64177bdb1faa64d3804.svg"
          alt="left-hero"
          className="right-hero"
        />
        <img
          src="https://merllo.onrender.com/static/media/right-loginsignup-hero.3a2e83cef20d6bab2dbaf88d4a44819f.svg"
          alt="rightHero"
          className="right-hero"
        />
      </div>
